...
**├── .gitignore # Git ignore rules for executables 
     and object files**
...
1. **Clone** the repository:
   ```bash
   git clone https://github.com/ZinAlabdin-source/Simple-Bank-Client-Management-System-With-Extension-Project-2.git
2. **Navigate** to the project folder and open `main.cpp` in your IDE.

3. **Compile** the code. For example, with g++:

     g++ main.cpp -o BankSystem.exe
4. **Run** the executable:

     BankSystem.exe
5. **Use** the menu numbers to navigate and enjoy!
